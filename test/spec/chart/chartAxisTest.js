'use strict';
describe('Chart: update axes', function () {
  var chart;
  ...
  it('creates x axis', function () {
    var xAxis = d3.select('.xaxis');
    expect(xAxis.attr('transform')).toBe('translate(0,460)');
  });

  it('creates y axis', function () {
    var yAxis = d3.select('.yaxis');
    expect(yAxis[0][0]).not.toBeNull();
  });
